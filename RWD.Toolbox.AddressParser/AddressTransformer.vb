...
#Region "For Testing Only"
   ...
   Private _displayPatternsForTesting As Boolean = True

   Private Sub ShowStringInTextEditor(pattern As String, title As String)
      Dim tempFolder As String = Path.Combine(My.Computer.FileSystem.SpecialDirectories.Desktop, "PatternsVB")
      Dim tempFile As String = Path.Combine(tempFolder, title & ".txt")

      File.WriteAllText(tempFile, pattern)
